  ...
  let consulta = (hero) => {
    if (hero && expresion.test(hero)) {
      $.ajax({
        dataType: "json",
        type: "GET",
        url: `https://www.superheroapi.com/api.php/2852563895011128/${hero}`,
              ...
              result.name
               ...
               <div class ="col-md-8">
                 ...
                 <ul class="list-group list-group-flush>
                    ...
                    <li class="list-group-item"><em>Ocupacion:</em> ${
                      result.work.occupation
                    }</li>
                    <li class="list-group-item"><em>Primera Aparicion:</em> ${
                      result.biography[`first-appearance`]
                    }</li>
                    <li class="list-group-item"><em>Altura:</em> ${result.appearance.height.join(
                      " - "
                    )}.</li>
                    <li class="list-group-item"><em>Peso:</em> ${result.appearance.weight.join(
                      " - "
                    )}.</li>
      ...
      alert("Ingrese solamente un numero");
    }
  };
